...
export const GET_SOME_CHANNEL_MESSAGES = "GET_SOME_CHANNEL_MESSAGES";
export const PARTIAL_LOADING_STARTED = "PARTIAL_LOADING_STARTED";
export const PARTIAL_LOADING_DONE = "PARTIAL_LOADING_DONE";
